                           ...
                           argonColumn(
                             ...
                             argonTabSet(
                               ...
                               argonTab(
                                 ...
                                 active = FALSE,
                                 argonRow(
                                   p("Social Gathering Lorong merupakan kegiatan pembinaan lorong yang bertujuan untuk transfer knowledge antara SR dan Insan Asrama. Kegiatan ini biasanya diselenggarakan satu kali dalam sebulan.")
                                 )
                               ),
                               argonTab(
